...
# modify by lzj
parser.add_argument('--voc_root', default=SIXray_ROOT, help='Location of VOC root directory')
...
def test_voc():
    ...
    testset = SIXrayDetection(args.voc_root, set_type, None, SIXrayAnnotationTransform())
    if args.cuda:
        net = net.cuda()
