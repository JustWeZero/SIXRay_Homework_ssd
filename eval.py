...
parser.add_argument('--imagesetfile',
                    ...
                    # default=r"D:\Python_Project\ssd.pytorch-master\battery_dataset_unbalance\validation\sub_train_core_coreless.txt", type=str,
                      default=r"/home/g203-server3/ssd.pytorch-master/battery_dataset_unbalance/validation/sub_train_core_coreless.txt", type=str,
...
set_type = 'validation'
# modify by lzj 修改路径
annopath = os.path.join(args.SIXray_root,set_type, 'Anno_core_coreless_battery_sub_5000_500', '%s.xml')
imgpath = os.path.join(args.SIXray_root, set_type,'cut_Image_core_coreless_battery_sub_5000_500', '%s.jpg')
...
def parse_rec(filename,imgpath):
    ...
    # modify by lzj windows下路径都是‘\’分隔，改掉
    img_fold_name = imgpath.split('/')[-2]
    # img_fold_name = imgpath.split('\\')[-2]

    # modify by lzj 路径改掉
    # imagename0 = filename.replace('Anno_core_coreless_battery_sub_2000_500', 'img_fold_name')
    imagename0 = filename.replace('Anno_core_coreless_battery_sub_5000_500', 'cut_Image_core_coreless_battery_sub_5000_500')
...
def reset_args(EPOCH):
    global args
    # modify by lzj 改路径
    # args.trained_model = "D:\\Python_Project\\Portable_Battery\\model\\mymodel_{:d}.pth".format(
    #         EPOCH)
    args.trained_model = r"/home/g203-server3/ssd.pytorch-master/weights/ssd300_mAP_77.43_v2.pth".format(
        EPOCH)

    # modify by lzj 改路径
    saver_root = r'/home/g203-server3/ssd.pytorch-master/weights/model'
...
if __name__ == '__main__':
    ...
    # for EPOCH in EPOCHS:
        ...
        # load data
        dataset = SIXrayDetection(args.SIXray_root, args.imagesetfile,set_type,
