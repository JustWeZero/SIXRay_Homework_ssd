...
# modify by lzj 20191210 数据集路径变更
SIXray_ROOT = r"/home/g203-server3/ssd.pytorch-master/battery_dataset_unbalance/"
...
class SIXrayDetection(data.Dataset):
    ...
    def __init__(self, root,
        ...
        # modify by lzj 这里应该是标注文件的文件夹路径，学长的是Anno_core_coreless_battery_sub_2000_500，改为自己的Anno_core_coreless_battery_sub_5000_500，相对的，训练集测试集文件结构也要改
        self._annopath = osp.join('%s' % self.root,set_type ,'Anno_core_coreless_battery_sub_5000_500', '%s.txt')

        # comment by lzj 学长测试用的tiff格式的图片路径，用不到，也不影响，只修改self._imgpath_jpg
        ...
        self._imgpath_jpg = osp.join(self.root,set_type+r'/cut_Image_core_coreless_battery_sub_5000_500', '%s.jpg')
        self.ids = list()
