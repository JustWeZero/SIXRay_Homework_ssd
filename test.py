...
parser.add_argument('--imagesetfile',
                    ...
                    default=r"/home/g203-server3/ssd.pytorch-master/battery_dataset_unbalance/test/sub_train_core_coreless.txt",
                    type=str,
...
def parse_rec(filename, imgpath):
    ...
    imagename0 = filename.replace('Anno_core_coreless_battery_sub_5000_500',
                                  'cut_Image_core_coreless_battery_sub_5000_500')
